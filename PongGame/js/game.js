...
var labels =
{
	instructions: 'Left paddle: A to move up, Y to move down.\n\nRight paddle: UP and DOWN keys.\n\n- click to start -',
	winner: 'Winner!'
};
...
var mainState = {
	...
	// The startGame function will be used to reset the ball, paddles and scores. It will also be used to enable paddle controls and collision detection.
	startGame: function()
	{
	...
	// The resetBall function will be used to reset our ball when a point is scored, when the game begins and when the game ends.
	resetBall: function()
	{
	...
	// The startBall function will be used to get our ball moving after it has been reset. There is also a slight delay before the ball starts moving.
	startBall: function()
	{
	...
	// The enablePaddles function will be used to hide/show our paddles, enable player controls, and enable collision detection.
	...
	collideWithPaddle: function(ball, paddle)
	{
		...
		var returnAngle;
		var segmentHit = Math.floor((ball.y - paddle.y) / gameProperties.paddleSegmentsMax);
